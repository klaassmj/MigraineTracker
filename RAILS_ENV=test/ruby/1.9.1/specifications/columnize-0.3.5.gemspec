...
```
  ...
  s.files = [".gitignore", "AUTHORS", "COPYING", "ChangeLog", "Makefile", "NEWS", "README.md", "Rakefile", "columnize.gemspec", "lib/Makefile", "lib/columnize.rb", "lib/version.rb", "test/test-columnize.rb", "test/test-hashparm.rb", "test/test-issue3.rb"]
  s.homepage = %q{https://github.com/rocky/columnize}
  s.licenses = ["Ruby", "GPL2"]
  s.rdoc_options = ["--main", "README", "--title", "Columnize 0.3.5 Documentation"]
  s.require_paths = ["lib"]
