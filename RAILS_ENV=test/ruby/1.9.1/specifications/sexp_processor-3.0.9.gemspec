...
for your language processing pleasure.}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/composite_sexp_processor.rb", "lib/pt_testcase.rb", "lib/sexp.rb", "lib/sexp_processor.rb", "lib/unique.rb", "test/test_composite_sexp_processor.rb", "test/test_environment.rb", "test/test_sexp.rb", "test/test_sexp_processor.rb", ".gemtest"]
