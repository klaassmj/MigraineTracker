...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", ".rspec", ".travis.yml", "Gemfile", "LICENSE", "README.md", "Rakefile", "childprocess.gemspec", "lib/childprocess.rb", "lib/childprocess/abstract_io.rb", "lib/childprocess/abstract_process.rb", "lib/childprocess/errors.rb", "lib/childprocess/jruby.rb", "lib/childprocess/jruby/io.rb", "lib/childprocess/jruby/process.rb", "lib/childprocess/jruby/redirector.rb", "lib/childprocess/unix.rb", "lib/childprocess/unix/io.rb", "lib/childprocess/unix/process.rb", "lib/childprocess/version.rb", "lib/childprocess/windows.rb", "lib/childprocess/windows/api.rb", "lib/childprocess/windows/constants.rb", "lib/childprocess/windows/functions.rb", "lib/childprocess/windows/handle.rb", "lib/childprocess/windows/io.rb", "lib/childprocess/windows/process.rb", "lib/childprocess/windows/structs.rb", "spec/abstract_io_spec.rb", "spec/childprocess_spec.rb", "spec/jruby_spec.rb", "spec/pid_behavior.rb", "spec/spec_helper.rb", "spec/unix_spec.rb", "spec/windows_spec.rb"]
