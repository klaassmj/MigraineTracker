...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/decent_exposure/default_exposure.rb", "lib/decent_exposure/railtie.rb", "lib/decent_exposure/version.rb", "lib/decent_exposure.rb", "README.md", "COPYING", "init.rb", "rails/init.rb"]
